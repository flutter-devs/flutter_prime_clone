...
class GenreLanguage extends StatefulWidget {
  final String genereTitle;
  GenreLanguage({
    this.genereTitle
});

  @override
  _GenreLanguageState createState() => _GenreLanguageState();
}

class _GenreLanguageState extends State<GenreLanguage> {

  GlobalKey<ScaffoldState> _scaffoldsKey;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    _scaffoldsKey = GlobalKey();
  }
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Text(widget.genereTitle,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800,fontSize: 16),),
              SizedBox(height: 30,),
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      _scaffoldsKey.currentState.openEndDrawer();
